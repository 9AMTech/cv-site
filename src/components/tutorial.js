...
export default function Tutorial({ tutorialController, previousPage, nextPage, enterTutorial, exitTutorial }) {
	const tutorialPages = [
		{
			image: PoshGoose,
		...
		},
		{
			...
			content: "You finally made it to the end of the tutorial! If you want to view this again, hit the first Question Mark Logo! Enjoy Simple-CV!"
		},
	]
				...
				: <section className='tutorial-focus place-center'>
					<section className='tutorial-wrapper place-center'>
						<section className='tutorial-content place-center'>
							<img className='tutorial-image' src={tutorialPages[tutorialController.activePage].image} alt={tutorialPages[tutorialController.activePage].altText} />
