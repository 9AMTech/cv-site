	...
	return (
		<section className={OutputCSS.workHistory + ' preview-padding'}>
			...
			<section>
				...
				<p className={OutputCSS.dates}>{formatDate(workHistory[0].startDate, true)} {workHistory[0].currentJob === true ? 'Current' : formatDate(workHistory[0].endDate, false)}</p>
			...
			{displayComponent.workHistory1 === true
				? <section>
					...
					<p className={OutputCSS.dates}>{formatDate(workHistory[1].startDate, true)} {workHistory[1].currentJob === true ? 'Current' : formatDate(workHistory[1].endDate, false)}</p>
			...
			{displayComponent.workHistory2 === true
				? <section>
					...
					<p className={OutputCSS.dates}>{formatDate(workHistory[2].startDate, true)} - {workHistory[2].currentJob === true ? 'Current' : formatDate(workHistory[2].endDate, false)}</p>
